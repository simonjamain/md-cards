(function() {
  $('.material_card-thumnail.video').each(function() {
    ...
    $(this).one('click',function() {
      ...
      var player = $('<iframe scrolling="no" class="player" width="'+$(this).width()+'" height="'+$(this).height()+'" src="https://www.youtube.com/embed/'+youtubeId+'?rel=0&autoplay=1&controls=0" frameborder="0" allowfullscreen id="yes"></iframe>').appendTo($(this));
